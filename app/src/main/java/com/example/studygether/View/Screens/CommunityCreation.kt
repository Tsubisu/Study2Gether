            ...
            Column(modifier= Modifier.fillMaxSize().verticalScroll(scrollState),
                ...
                Row(Modifier.fillMaxWidth(),
                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally){
                        ...
                        Text("Create Your Community", style = MaterialTheme.typography.bodyMedium, color = MaterialTheme.colorScheme.onBackground.copy(alpha = 0.7f))
                    }
                }
                Row(
                    Modifier
                        ...
                        Column(
                            ...
                            )
                            {
                                OutlinedTextField(
                                    ...
                                    supportingText = { if (uiState.communityNameError.isNotEmpty()) Text(uiState.communityNameError, color = Color(0xFFFFD2D2)) },
                                    shape = RoundedCornerShape(14.dp),
                                    colors = inputColors,
                                    modifier = Modifier.weight(1f)
                                )
